...
export const APPS: AppDef[] = [
  ...
  { id: "browser", name: "Safari", glyph: "browser", color: "linear-gradient(135deg, #5ac8fa, #007aff)", kind: "browser" },
  {
    id: "claude",
    name: "Claude",
    glyph: "claude",
  ...
  { id: "settings", name: "Settings", glyph: "settings", color: "linear-gradient(135deg, #8e8e93, #48484a)", kind: "settings" },
];
